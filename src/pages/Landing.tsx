...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50/30 overflow-hidden">
      {/* Hero */}
      <div className="relative">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-5 max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="px-5 py-2.5 text-sm font-medium text-gray-600 hover:text-purple-600 transition-colors"
            >
              Sign In
            </button>
            <button
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 border border-purple-100 rounded-full text-sm text-purple-600 font-medium mb-8">
          ...
          >
            <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-purple-200/30 border border-purple-100/50 p-8">
              ...
              <div className="space-y-3">
                {['Design new landing page', 'Review pull requests', 'Update documentation'].map((task, i) => (
                  <motion.div
                    ...
                    className="flex items-center gap-3 p-3 rounded-2xl bg-purple-50/50"
                  >
                    <div className={`w-5 h-5 rounded-lg border-2 ${i === 2 ? 'bg-purple-500 border-purple-500' : 'border-purple-200'}`} />
                    <span className={`text-sm ${i === 2 ? 'line-through text-gray-400' : 'text-gray-700 font-medium'}`}>{task}</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 border border-purple-50 shadow-lg shadow-purple-100/20 hover:shadow-xl transition-shadow"
            >
